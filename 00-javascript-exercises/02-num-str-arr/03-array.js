...
//   function find9(nums) {
//     return nums.filter(num => num === 9).length;        // Eszti
// }

// function find9(nums) {                                      // Márk 
//     let count = 0;
...
// function firstLast6(nums) {                                                     // Gipi
//     return nums[0] === 6 || nums[nums.length - 1] === 6;
// }


function firstLast6(nums) {                                                     // Márk
...
// function makePi() {                                         // Gipi
//     return [3, 1, 4];
//   }

function makePi() {                                         // Márk
    const PI = Math.PI;
