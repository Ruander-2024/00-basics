...
//
// Input: console.log(myPop([63, 48, 11, 9, 46, 73, 35]));
// Output: 35
...
//
// Input: console.log(mySlice(["apple", "banana", "orange", "grape fruit", "melon"]));
...
//
// Input: console.log(mySplice([22, 6, 5, 91, 27], 33));
// Output: [22, 6, 5, 91, 27]

// Input: console.log(mySplice([22, "data", 5, 91, 27], 33));
// Output: ["data"]
...
//
// Input: console.log(myShift(["0th", "1st", "2nd", "3rd"]));
// Output: "1st"
