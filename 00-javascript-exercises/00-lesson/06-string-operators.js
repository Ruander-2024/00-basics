...
console.log(userName.toLocaleLowerCase()); // kisebetűssé akakítás
console.log(userName.toLocaleUpperCase()); // nagybetűssé alakítás

console.log(userName.charAt(0)); // n-edik karakter
...
console.log(userName.substring(0, 4)); // 0.1 karaktertől a 4-ig, de a 4. nincsen benne
...
console.log(userName.replace(/l/g, "x")); // Globálisan (g) az összes "l" betűt cseréljük
...
console.log(sentence.includes("Gates")); // Keres, hogy létezik-e ilyen és trze vagy false értéket ad vissza
...
// Split
console.log(sentence.split(" ")); // A "" közé írt karakter szerint választja szét a változó értékét
