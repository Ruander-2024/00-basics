...
console.log(myArray[6]); // Undefined -> tömbön kívűl mutat
...
newArrayLength = numList.unshift(1, 2);
console.log(numList);
console.log(newArrayLength);
...
console.log("----- Join -----");
// Összefűzi a tömb elemeket vesszővel
...
console.log(animals[2].charAt(0).toLocaleUpperCase() + animals[2].slice(1)); // Az utolsó elem első karakterének változtatása
...
numArray.pop(); // Eleme eltávolítása a tömb végéről
...
numArray.shift(); // Elem eltávolítása a tömb elejére
