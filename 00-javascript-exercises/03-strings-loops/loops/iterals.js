...
//     // Ha a feltétel teljesül, akkor lehet eltávolítani az elemeket
//     if (index <= array.length - (index + 1)) {
...
// Térjen vissza csak az érvényes neveket tartalmazó tömbbel


console.log(collectValidUserNames(['admin43', 'JohhDee', 'Boy3', 'AdMiN8'])); // Output: [];
